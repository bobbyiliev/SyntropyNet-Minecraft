            ...
            <div class="px-8 pt-6 pb-8 space-y-6">
                ...
                <div>
                    <nav class="grid row-gap-8">
                        ...
                        <a href="https://github.com/bobbyiliev/SyntropyNet-Minecraft" class="flex items-center p-3 -m-3 space-x-3 transition duration-150 ease-in-out rounded-md hover:bg-gray-50">
