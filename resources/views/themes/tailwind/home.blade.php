            ...
            <div class="max-w-6xl px-10 pb-20 mx-auto bg-gray-100">
                <div class="flex flex-col items-center lg:flex-row">
                    <div class="flex flex-col justify-center w-full h-full mb-10 lg:pr-8 sm:w-4/5 md:items-center lg:mb-0 lg:items-start md:w-3/5 lg:w-1/2">
                        <p class="mb-2 text-base font-medium tracking-tight uppercase text-wave-500">MC Panel</p>
                        <h2
                            class="text-4xl font-extrabold leading-10 tracking-tight text-gray-900 sm:leading-none lg:text-5xl xl:text-6xl">
                            Our Team</h2>
                        <p class="pr-5 my-6 text-lg text-gray-600 md:text-center lg:text-left">The MC Panel was created by:</p>
                        <a href="https://github.com/bobbyiliev/SyntropyNet-Minecraft"
                        ...
                        <blockquote class="flex flex-row-reverse items-center justify-between w-full col-span-1 p-6 bg-white rounded-lg shadow sm:flex-row">
                            <div class="flex flex-col pl-5 sm:pr-8">
                                <div class="relative sm:pl-12">
                                    ...
                                    <p class="mt-3 text-base font-medium text-wave-500 truncate"><a href="https://twitter.com/bobbyiliev_">Bobby Iliev </a>
                                    </p>
                                </div>

                                <h3 class="mt-3 text-base font-medium leading-5 text-gray-800 truncate sm:pl-12"><span
                                        class="mt-1 text-sm leading-5 text-gray-500 truncate">DevOps engineer and Web developer</span></h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                            <img class="flex-shrink-0 w-24 h-24 bg-gray-300 rounded-full"
                                src="/themes/tailwind/images/bobby-iliev.jpeg"
                                alt="Bobby Iliev">
                        </blockquote>
                        <blockquote
                            ...
                            <div class="flex flex-col pl-5 sm:pr-10">
                                <div class="relative sm:pl-12">
                                    ...
                                    <p class="mt-3 text-base font-medium text-wave-500 truncate"><a href="https://twitter.com/asciiden">Denislav Gavrilov </a>
                                    </p>
                                </div>
                                <h3 class="mt-3 text-base font-medium leading-5 text-gray-800 truncate sm:pl-12"><span
                                        class="mt-1 text-sm leading-5 text-gray-500 truncate">DevOps engineer and Web developer</span></h3>
                            ...
                            <img class="flex-shrink-0 w-24 h-24 bg-gray-300 rounded-full"
                                src="/themes/tailwind/images/denislav.jpg"
                                alt="Denislav">
                        </blockquote>
